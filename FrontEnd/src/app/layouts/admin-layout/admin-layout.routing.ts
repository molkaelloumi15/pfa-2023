...
export const AdminLayoutRoutes: Routes = [
  ...
  { path: 'department/depMod', component: DepModComponent },
  { path: 'department/depCon', component: DepConComponent },
  { path: 'projet_recherche', component: ProjetComponent },
  { path: 'projet_recherche/proAdd', component: ProAddComponent },
  { path: 'projet_recherche/proMod', component: ProModComponent },
  { path: 'projet_recherche/proCon', component: ProConComponent },
  { path: 'emp', component: EmployeeComponent },
  { path: 'emp/empAdd', component: EmpAddComponent },
  { path: 'emp/empMod', component: EmpModComponent },
  { path: 'emp/empCon', component: EmpConComponent },
  { path: 'tel', component: TelComponent },
  { path: 'tel/telAdd', component: TelAddComponent },
  { path: 'tel/telMod', component: TelModComponent },
  { path: 'etude', component: EtudesComponent },
  { path: 'etude/etudeAdd', component: EtudAjoutComponent },
  { path: 'etude/etudeMod', component: EtudModificationComponent },
  { path: 'bureau', component: BureauComponent },
  { path: 'bureau/burAdd', component: BurAddComponent },
  { path: 'bureau/burMod', component: BurModComponent },
  { path: 'bureau/burCon', component: BurConComponent }
];
